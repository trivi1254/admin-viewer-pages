    ...
    <div className="min-h-screen flex flex-col bg-[#f5f7fa]">
      ...
      <header className="w-full py-4 px-6 flex items-center justify-between bg-white shadow-sm">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-gray-600">
          ...
          <span className="text-[#00d4aa] font-medium border-b-2 border-[#00d4aa] pb-1">Cuenta</span>
        </nav>
      </header>
            ...
            <div className="space-y-4">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-white text-gray-400">o inicia sesión con correo</span>
                </div>
              </div>
